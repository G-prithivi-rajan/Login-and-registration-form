...
def login():
    ...
    if  username == ''or password =='':
        ...
        for i in creat:                                                
            name.append(i[0]) 
            passw.append(i[1])
            if username not in name and password not in passw:
        ...
        messagebox.showwarning('Account','please first create a Account!')
...
def register():
    ...
    Label1=Label(top,text='enter your details',bg="blue",fg='white',font=("areal",25))
    ...
    def register_complet():
        ...
        if UserNmae =='' or password =='' or mo_number =='' or gmail =='' or age =='':
...
Label1=Label(root,text='login page',bg="blue",fg='white',font=("areal",25))
Label1.place(x=600,y=10)
